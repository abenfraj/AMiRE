    ...
    <form @submit="handleSubmit" :class="{box: isEdit}" class="block" style="margin-top: 3rem;">
        ...
        <div>
            ...
            <div class="field">
                ...
                <EditableTags v-model="enseignant.interetsDomaines" :isEdit="isEdit" required></EditableTags>
            </div>
            <div class="field">
                <label class="label">Niveaux souhaités</label>
                <EditableTags v-model="enseignant.niveauxSouhaites" :isEdit="isEdit" required></EditableTags>
            </div>
        </div>
    </form>
</template>
