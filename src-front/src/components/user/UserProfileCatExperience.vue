...
<template>  
    <form @submit="handleSubmit" :class="{box: isEdit}" class="block" style="margin-top: 3rem;">
        ...
        <div>
            <div class="field">
                ...
                <EditableTextarea v-model="enseignant.experience" :isEdit="isEdit" type="text" required></EditableTextarea>
            </div>
            
            <div class="field">
                <label class="label">Titres académiques</label>
                <EditableTextarea v-model="enseignant.titresAcademiques" :isEdit="isEdit" type="text" required></EditableTextarea>
            </div>
            <div class="field">
                <label class="label">Autres informations</label>
                <EditableTextarea v-model="enseignant.divers" :isEdit="isEdit" type="text" required></EditableTextarea>
            </div>
            <div class="field">
                <label class="label">Références</label>
                <EditableTextarea v-model="enseignant.recommandations" :isEdit="isEdit" type="text" required></EditableTextarea>
            </div>
            <div class="field">
                <label class="label">Évaluations</label>
                <EditableTextarea v-model="enseignant.evaluation" :isEdit="isEdit" type="text" required></EditableTextarea>
            </div>
        </div>
    </form>
</template>
